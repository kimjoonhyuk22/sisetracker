...
fly_image = pygame.image.load("C:\\Users\\User\\Desktop\\PythonWorkspace\\start_coding\\start_coding\\images\\fly.png").convert_alpha()

fly_sound = pygame.mixer.Sound("C:\\Users\\User\\Desktop\\PythonWorkspace\\start_coding\\start_coding\\sounds\\fly-buzz.ogg")
menu = "start"
homescreen_image = pygame.image.load("C:\\Users\\User\\Desktop\\PythonWorkspace\\start_coding\\start_coding\\images\\flycatcher_home.png").convert_alpha()
font = pygame.font.SysFont("draglinebtndm",60)
frog_image = pygame.image.load("C:\\Users\\User\\Desktop\\PythonWorkspace\\start_coding\\start_coding\\images\\frog.png").convert_alpha()

tongue_sound = pygame.mixer.Sound("C:\\Users\\User\\Desktop\\PythonWorkspace\\start_coding\\start_coding\\sounds\\tongue.ogg")
font2 = pygame.font.SysFont("couriernew",15)

death_time = False
gameover_image = pygame.image.load("C:\\Users\\User\\Desktop\\PythonWorkspace\\start_coding\\start_coding\\images\\flycatcher_game_over.png").convert_alpha()
