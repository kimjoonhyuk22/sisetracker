...
badguy_image = pygame.image.load("C:\\Users\\User\\Desktop\\PythonWorkspace\\start_coding\\start_coding\\images\\badguy.png").convert()
last_badguy_spawn_time = 0
badguy_image.set_colorkey((0,0,0))
fighter_image = pygame.image.load("C:\\Users\\User\\Desktop\\PythonWorkspace\\start_coding\\start_coding\\images\\fighter.png").convert()
fighter_image.set_colorkey((255,255,255))
missile_image = pygame.image.load("C:\\Users\\User\\Desktop\\PythonWorkspace\\start_coding\\start_coding\\images\\missile.png").convert()
missile_image.set_colorkey((255,255,255))

score = 0
font = pygame.font.Font(None,20)
GAME_OVER = pygame.image.load("C:\\Users\\User\\Desktop\\PythonWorkspace\\start_coding\\start_coding\\images\\gameover.png").convert()
...
class Missile:
    ...
    def off_screen(self):
        return self.y< -8
    def draw(self):
        #screen.blit(missile_image,(self.x-self.dx,self.y))
