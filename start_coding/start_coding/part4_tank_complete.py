...
homescreen_image = pygame.image.load("C:\\Users\\User\\Desktop\\PythonWorkspace\\start_coding\\start_coding\\images\\TBhomescreen.jpg").convert()
landscape_image = pygame.image.load("C:\\Users\\User\\Desktop\\PythonWorkspace\\start_coding\\start_coding\\images\\landscape.jpg").convert()
wall_image = pygame.image.load("C:\\Users\\User\\Desktop\\PythonWorkspace\\start_coding\\start_coding\\images\\wall.png").convert()
vert_wall_image = pygame.transform.rotate(wall_image,90)
tankG_image = pygame.image.load("C:\\Users\\User\\Desktop\\PythonWorkspace\\start_coding\\start_coding\\images\\tankG.png").convert_alpha()
tankB_image = pygame.image.load("C:\\Users\\User\\Desktop\\PythonWorkspace\\start_coding\\start_coding\\images\\tankB.png").convert_alpha()
menu = "home"
shell_sound = pygame.mixer.Sound("C:\\Users\\User\\Desktop\\PythonWorkspace\\start_coding\\start_coding\\sounds\\shell.ogg")
harm_sound = pygame.mixer.Sound("C:\\Users\\User\\Desktop\\PythonWorkspace\\start_coding\\start_coding\\sounds\\tank_hit.ogg")
G_lives=(
    pygame.image.load("C:\\Users\\User\\Desktop\\PythonWorkspace\\start_coding\\start_coding\\images\\lives_1G.png").convert_alpha(),
    pygame.image.load("C:\\Users\\User\\Desktop\\PythonWorkspace\\start_coding\\start_coding\\images\\lives_2G.png").convert_alpha(),
    pygame.image.load("C:\\Users\\User\\Desktop\\PythonWorkspace\\start_coding\\start_coding\\images\\lives_3G.png").convert_alpha()
    )
B_lives=(
    pygame.image.load("C:\\Users\\User\\Desktop\\PythonWorkspace\\start_coding\\start_coding\\images\\lives_1B.png").convert_alpha(),
    pygame.image.load("C:\\Users\\User\\Desktop\\PythonWorkspace\\start_coding\\start_coding\\images\\lives_2B.png").convert_alpha(),
    pygame.image.load("C:\\Users\\User\\Desktop\\PythonWorkspace\\start_coding\\start_coding\\images\\lives_3B.png").convert_alpha()
    )
G_wins = pygame.image.load("C:\\Users\\User\\Desktop\\PythonWorkspace\\start_coding\\start_coding\\images\\greenwins.jpg").convert()
B_wins = pygame.image.load("C:\\Users\\User\\Desktop\\PythonWorkspace\\start_coding\\start_coding\\images\\bluewins.jpg").convert()
shell_image = pygame.image.load("C:\\Users\\User\\Desktop\\PythonWorkspace\\start_coding\\start_coding\\images\\shell.png").convert_alpha()
ammobox_image = pygame.image.load("C:\\Users\\User\\Desktop\\PythonWorkspace\\start_coding\\start_coding\\images\\ammobox.png").convert_alpha()
